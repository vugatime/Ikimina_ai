    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="login.php" class="px-4 py-2 text-sm font-semibold text-gray-700 hover:text-gray-900 no-underline transition"><?php echo __('sign_in'); ?></a>
                <a href="register.php" class="px-5 py-2.5 rounded-xl text-sm font-bold text-white no-underline transition shadow-md" style="background:#0F766E;"><?php echo __('get_started'); ?></a>
            </div>
        </div>
    </div>
</nav>
    ...
    <div class="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        <div class="flex-1 text-center lg:text-left animate-slide-left">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                <a href="register.php" class="px-8 py-3.5 rounded-xl text-base font-bold text-white no-underline transition shadow-lg" style="background:#0F766E;"><?php echo __('start_free_trial'); ?></a>
...
<section class="py-16 px-4" style="background:#0F172A;">
    <div class="max-w-3xl mx-auto text-center">
        ...
        <a href="register.php" class="inline-block px-8 py-3.5 rounded-xl text-base font-bold text-white no-underline transition shadow-lg" style="background:#0F766E;"><?php echo __('get_started_free'); ?></a>
    </div>
</section>
