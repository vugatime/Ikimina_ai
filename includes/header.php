    ...
    <div class="flex flex-1">
        <aside id="sidebar" class="fixed left-0 top-0 h-full w-64 bg-sidebar text-white z-40 flex flex-col overflow-y-auto">
            ...
            <nav class="flex-1 p-3 space-y-0.5">
                ...
                <!-- MEMBER MENU -->
                <?php if ($isMember): ?>
                <a href="<?php echo $base; ?>loans/request.php" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-300 text-sm font-medium"><?php echo __('request_loan'); ?></a>
                <a href="<?php echo $base; ?>report.php" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-300 text-sm font-medium"><?php echo __('my_report'); ?></a>
                <?php endif; ?>
        ...
        <div class="flex-1 flex flex-col min-h-screen ml-0 md:ml-64">
            <header class="sticky top-0 z-20 bg-white/90 backdrop-blur-xl border-b border-gray-200/60 px-4 md:px-6 py-3 flex items-center justify-between flex-shrink-0 shadow-sm">
                ...
                <div class="flex items-center gap-3 relative">
                    ...
                    <div class="relative">
                        <button onclick="document.getElementById('dropdownMenu').classList.toggle('show')" class="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-gray-50 border border-gray-200 hover:bg-gray-100 transition text-left">
                        ...
                        <div id="dropdownMenu" class="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50">
